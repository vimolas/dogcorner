...
Dog.create(
  ...
  age: 6,
  pedigree: false,
  location: "Via Giannone, Milano")
Dog.create(
  name: "Rusty",
  breed_id: 5,
  user_id: 3,
  photo: "https://images.unsplash.com/photo-1508946621775-9d59b75e074e?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=2c7b085d9d776ecdd4d0b103fbef607d&dpr=1&auto=format&fit=crop&w=1000&q=80&cs=tinysrgb",
  description: "Loving beagle, perfect for families",
  age: 9,
  pedigree: false,
...
Dog.create(
  ...
  breed_id: 2,
  user_id: 2,
  description: "After being a stray on the streets, Maddux has blossomed into a sweet little guy. He can be shy and timid at times but overall is a happy playful dog. He's a people person and loves to be with his human. He does well with dogs especially big ones. His foster brother and sister enjoy him being part of the dog pack. Maddux loves car rides, walks, chilling in the yard or sleeping on the couch. This handsome boy is ready for his furever home. ",
  age: 4,
  pedigree: false,
